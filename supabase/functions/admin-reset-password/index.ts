...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Extract token and get user using admin client
    ...
    // Use the already created admin client to reset password
    ...
    console.log(`Admin ${userId} reset password for user ${targetUserId}`);
